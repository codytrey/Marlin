...
#define STRING_CONFIG_H_AUTHOR "(codytrey, Ender-3 Pro Metal)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro Metal"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40.39, -10, -1.8 }
