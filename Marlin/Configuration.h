...
#define STRING_CONFIG_H_AUTHOR "(Cody Belcher, TronXY HT)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "HT Abomination"
...
#define TOUCH_SCREEN
  ...
  #define TOUCH_CALIBRATION_X -17551
  #define TOUCH_CALIBRATION_Y   11702
  #define TOUCH_OFFSET_X         503
